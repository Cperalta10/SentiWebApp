...
export function MusicClips() {
  ...
  const musicClips: MusicClip[] = [
    {
      ...
      description: "Audio track de la canción original 'La Mejor Vista'",
      duration: '3:20',
      platform: 'YouTube',
      videoId: 'WQ_umyxUbbQ',
      thumbnail: 'https://img.youtube.com/vi/WQ_umyxUbbQ/maxresdefault.jpg',
      link: 'https://www.youtube.com/watch?v=WQ_umyxUbbQ',
    },
    {
      id: 1,
      title: 'Sentimiento - Dame Un Besito',
      description: "Audio track de la canción original 'Dame Un Besito'",
      duration: '2:56',
      platform: 'YouTube',
      videoId: 'nKLkN17bt40',
      thumbnail: 'https://img.youtube.com/vi/nKLkN17bt40/maxresdefault.jpg',
      link: 'https://www.youtube.com/watch?v=nKLkN17bt40',
    },
    {
      id: 2,
      title: 'Sentimiento - A Escondidas',
      description: "Audio track de la canción original 'A Escondidas'",
      duration: '3:17',
      platform: 'YouTube',
      videoId: 'w0L6mCANVqA',
      thumbnail: 'https://img.youtube.com/vi/w0L6mCANVqA/maxresdefault.jpg',
      link: 'https://www.youtube.com/watch?v=w0L6mCANVqA',
    },
  ];
  ...
  return (
    <section
      id="music"
      className="container mx-auto mt-10 px-4 py-10 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800"
    >
      <div className="text-center mb-12">
        <h2 className="font-bold text-4xl mb-4">Latest Music Videos</h2>
        <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
          Watch Sentimiento's latest music videos and experience the raw emotion
          behind his music.
        </p>
      </div>
                ...
                <>
                  ...
                  >
                    <div className="w-20 h-20 bg-red-600 rounded-full flex items-center justify-center transition-colors duration-300">
                      <i
                        className="fa-solid fa-play text-3xl text-white ml-1"
                        aria-hidden="true"
                      ></i>
                    </div>
                  </button>
